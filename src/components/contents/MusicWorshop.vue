  ...
  container#mw(arrow="true")
    ...
    .videos
      .box(style="paddingRight: 20px")
        iframe(src="https://www.youtube.com/embed/E1Sw6L4PpFI", frameborder="0", allowfullscreen)
      .box
        iframe(src="https://www.youtube.com/embed/PDS1D5QdhrU", frameborder="0", allowfullscreen)
